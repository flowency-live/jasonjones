  ...
  return (
    <div className="space-y-5 text-[16px] leading-relaxed text-[#d0d8e0]">
      ...
      <div className="hidden lg:block space-y-5">
        ...
        <p>I've attended the global Kanban University Learnship conferences in Miami and Bilbao, where the people who are genuinely serious about this come together. The thought leadership coming out of that community continues to inform how I work. I use the <a href="https://kanban.plus/pages/kanban-maturity-model" target="_blank" rel="noopener noreferrer" className="text-[#ea580c] hover:underline">Kanban Maturity Model</a> to help organisations understand where they are and plot a realistic path forward.</p>
